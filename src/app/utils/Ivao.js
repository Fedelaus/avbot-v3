  ...
  static async download() {
    ...
    clients.split('\n').forEach(c => {
      ...
      this.ivao.clients[t[0]] = {
        ...
        departureTime: t[22] ? (t[22].length == 2 ? `00:${t[22].substring(0, 2)}z` : t[22].length == 3 ? `0${t[22].substring(0, 1)}:${t[22].substring(1, 3)}z` : `${t[22].substring(0, 2)}:${t[22].substring(2, 4)}z`) : undefined || undefined,
